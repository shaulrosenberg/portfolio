...
import aiStartupLandingPage from "@/assets/images/trello1.png";
...
const portfolioProjects = [
  {
    ...
    link: "https://youtu.be/geRKHFzTxNY?si=sYsSNXMz55HxnN7a",
  ...
  },
  {
    company: "Trelluxe",
    year: "2023",
    title: "A Trello inspired tool",
    results: [
      { title: "Enhanced user experience by 40%" },
      { title: "Improved site speed by 50%" },
      { title: "Increased mobile traffic by 35%" },
    ],
    link: "https://trelluxe.onrender.com/",
